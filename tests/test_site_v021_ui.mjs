...
test('fresh analysis explains Brain9, separate pools, strict mapping and exact Frontal cortex curve',()=>{
  ...
  for(const phrase of ['eight adult brain categories + Embryo','excluded from Brain9 statistics and cosine',
    ...
    'GTEx Brain_Cortex (UBERON:0001870), polyA+ RNA-seq, unstranded','saved scores are not reused'])assert(text.includes(phrase),phrase);
